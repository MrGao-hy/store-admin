...
public class CodeGenerator {
    public static void main(String[] args) {
        ...
        String outputDir = "E:\\project\\mine\\java\\store-admin\\src\\main\\java";
        ...
        String tableName = "sys_user,sys_role,sys_user_role,sys_menu,sys_shop,sys_user_shop,sys_brand,sys_goods,sys_goods_shop";
